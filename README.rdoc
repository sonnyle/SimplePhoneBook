...
as usual to setup the invite tables. It is important that you have Imagemagick installed on your machine to handle the photo uploading.
Once the app is installed and setup, start the server:
